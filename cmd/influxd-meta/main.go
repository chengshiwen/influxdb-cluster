// Command influxd-meta is the InfluxDB Meta server.
package main
...
import (
	...
	"github.com/influxdata/influxdb/cmd/influxd-meta/help"
...
func (m *Main) Run(args ...string) error {
	...
	default:
		return fmt.Errorf(`unknown command "%s"`+"\n"+`Run 'influxd-meta help' for usage`+"\n\n", name)
	}

	return nil
}

// VersionCommand represents the command executed by "influxd-meta version".
...
func (cmd *VersionCommand) Run(args ...string) error {
	...
	// Print version info.
	fmt.Fprintf(cmd.Stdout, "InfluxDB Meta v%s (git: %s %s, build: %s %s/%s)\n", version, branch, commit,
		runtime.Version(), runtime.GOOS, runtime.GOARCH)

	return nil
}

var versionUsage = `Displays the InfluxDB Meta version, build branch and git commit hash.

Usage: influxd-meta version
`
